...
# Extraire l'année de la colonne 'DATE_ARRETE' et créer une nouvelle colonne 'year'
nouveau_csv['year'] = pd.to_datetime(nouveau_csv['DATE_ARRETE']).dt.year
...
nouveau_csv = nouveau_csv.groupby(['code_geo', 'latitude', 'longitude', 'year'], as_index=False).agg({
    'city_code': 'first',
    'zip_code': 'first',
    'DATE_ARRETE':'first',
